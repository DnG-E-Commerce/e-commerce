...
@section('content')
    ...
    <section>
        ...
        background-size: cover;">
                            ...
                            <p class="text-white position-relative">Lorem, ipsum dolor sit amet consectetur adipisicing
                                elit. Distinctio adipisci harum ratione aspernatur ut sapiente facilis molestias eveniet
                                impedit autem deserunt aliquam nisi laborum omnis, veniam alias, asperiores corrupti
                                explicabo.</p>
                        </div>
                    </div>
                </div>
